...
const footerLinks = {
  produit: [
    ...
    { name: "Plan annuel", href: "#plan-annuel" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 lg:py-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2 mb-4 lg:mb-0">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm mb-6">
              Plateforme de gestion, suivi et reporting des activités pour le
              MCNSLP Côte d&apos;Ivoire. Simplifiez la gestion de votre Direction.
            </p>
        ...
        <div className="py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500">
            © {currentYear} e-OSCS. Tous droits réservés — MCNSLP Côte d&apos;Ivoire
          </p>

          {/* Tagline */}
          <p className="text-xs text-slate-600 italic max-w-md text-center md:text-right">
            &laquo; Une donnée saisie une seule fois, exploitée à tous les niveaux du
            reporting. &raquo;
          </p>
        </div>
      </div>
